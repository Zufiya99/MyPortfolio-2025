...
const Hero = () => {
  return (
    <section id="home" className="flex flex-col items-center text-center bg-chineseBlack text-softWhite py-24 px-8">
      {/* Profile Image */}
      ...
      <div className="flex flex-wrap justify-center gap-8 mt-8">
        <button className="px-8 py-3 text-lg font-medium bg-tealGreen text-darkBlue rounded-full shadow-md transition-transform transform hover:scale-105 hover:bg-greenHover">
          Connect with Me
        </button>
        <button className="px-8 py-3 text-lg font-medium border-2 border-softWhite text-softWhite rounded-full shadow-md hover:border-tealGreen hover:bg-darkBlue transition-transform transform hover:scale-105">
          View Resume
        </button>
      </div>
    </section>
